...
2. **Does the observability category appear on the page?** §1.5 says the comparison strawmans by omission without it — but "Grafana/Datadog" may be too much surface area for a landing-page section. Decide: full row, one honest sentence ("already happy with Grafana? we're not for you"), or dedicated-page-only. _(Split out to its own grilling ticket by operator call: [#45](https://github.com/getalfredo/landing-page/issues/45).)_

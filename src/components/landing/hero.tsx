	...
	return (
		<section className="lp-hero" id="wp-hero">
			<h1 className="lp-h1">
				...
				<br />
				Watch them all from <span className="lp-brand">one HQ.</span>
			</h1>
			<p className="lp-sub">
				Alfredo is <span className="lp-accent">the home</span> for your
				projects. Your next one is live in minutes, with auth, email, database
				and analytics already configured and running. Every project you add is
			...
			<p className="lp-etch lp-hero-tabs">
				...
				<span className="lp-accent">ONE HQ</span>
			</p>

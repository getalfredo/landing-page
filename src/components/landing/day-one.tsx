	...
	return (
		<section className="lp-section" id="wp-deploy">
			...
			<p className="lp-body">
				...
				know if anyone shows up. Payments, because eventually you want to get
				paid. You have built all of this before, and you will build it again. Or
				you rent it: five managed services, five bills, none of it yours.
			</p>
			{/* The strip states the count before the payoff resolves it. */}
			<SetupTaxStrip />
